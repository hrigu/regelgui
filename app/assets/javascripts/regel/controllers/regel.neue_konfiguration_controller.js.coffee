      ...
      when variante.konfiguration == regel.Konfiguration.POSITION_KONFIGURATION
        switch
          when variante.auspraegung == regel.Konfiguration.AUSPRAEGUNG_MINIMIEREN
            new regel.Konfiguration(typ: variante.konfiguration, auspraegung: regel.Konfiguration.AUSPRAEGUNG_MINIMIEREN, regel_id: @regel.id, gruenorangerot_position_100: 10, mitarbeiter_ids: [])
          when variante.auspraegung == regel.Konfiguration.AUSPRAEGUNG_MAXIMIEREN
            new regel.Konfiguration(typ: variante.konfiguration, auspraegung: regel.Konfiguration.AUSPRAEGUNG_MAXIMIEREN, regel_id: @regel.id, gruenorangerot_position_100: 10, mitarbeiter_ids: [])

      when variante.konfiguration == regel.Konfiguration.GRUENORANGEROT_KONFIGURATION
        switch
          when variante.auspraegung == regel.Konfiguration.AUSPRAEGUNG_MINIMIEREN
            new regel.Konfiguration(typ: variante.konfiguration, auspraegung: regel.Konfiguration.AUSPRAEGUNG_MINIMIEREN, regel_id: @regel.id, gruen_untere_grenze: 10, orange_untere_grenze: 20, rot_untere_grenze: 30, mitarbeiter_ids: [])
          when variante.auspraegung == regel.Konfiguration.AUSPRAEGUNG_MAXIMIEREN
            new regel.Konfiguration(typ: variante.konfiguration, auspraegung: regel.Konfiguration.AUSPRAEGUNG_MAXIMIEREN, regel_id: @regel.id, gruen_obere_grenze: 80, orange_obere_grenze: 50, rot_obere_grenze: 20, mitarbeiter_ids: [])
          when variante.auspraegung == regel.Konfiguration.AUSPRAEGUNG_EINSCHRAENKEN
            new regel.Konfiguration(typ: variante.konfiguration, auspraegung: regel.Konfiguration.AUSPRAEGUNG_EINSCHRAENKEN, regel_id: @regel.id, gruen_untere_grenze: 30, orange_untere_grenze: 40, rot_untere_grenze: 50, gruen_obere_grenze: 30, orange_obere_grenze: 20, rot_obere_grenze: 10, mitarbeiter_ids: [])
